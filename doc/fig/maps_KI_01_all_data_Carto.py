...
germany = cx.Place("Deutschland", source = cx.providers.CartoDB.Positron)


# Get the shape of Germany
with rasterio.open("tifs/germany_Carto.tif") as r:
...
# Add the base map
cx.add_basemap(ax = ax, crs = gdf_germany.crs, source = "tifs/germany_Carto.tif", alpha = 1)
...
#### 03 Save as PDF
plt.savefig("maps_KI_01_all_data_Carto.pdf", bbox_inches = 'tight')