...
gdf_germany_weekend.plot(ax = ax1, markersize = 0, color = "k")
gdf_germany_weekday.plot(ax = ax2, markersize = 0, color = "k")


# Add the base map
cx.add_basemap(ax = ax1, crs = gdf_germany_weekend.crs, source = "tifs/germany_osm.tif", alpha = 0.7)
cx.add_basemap(ax = ax2, crs = gdf_germany_weekday.crs, source = "tifs/germany_osm.tif", alpha = 0.7)
...
cx.plot_map(im2, bbox, ax = ax1, title = "Weekends")
cx.plot_map(im2, bbox, ax = ax2, title = "Weekdays")
...
gdf_germany_weekend[condition].plot(ax = ax1, markersize = 1, marker = "o", color = "#19a824", alpha = 0.9, label = "< 6 min")
gdf_germany_weekend[~condition].plot(ax = ax1, markersize = 1, marker = "o", color = "crimson", alpha = 0.7, label = ">= 6 min")

condition = gdf_germany_weekday["Minutes of delay"] < 6
gdf_germany_weekday[condition].plot(ax = ax2, markersize = 1, marker = "o", color = "#19a824", alpha = 0.9, label = "< 6 min")
gdf_germany_weekday[~condition].plot(ax = ax2, markersize = 1, marker = "o", color = "crimson", alpha = 0.7, label = ">= 6 min")
...
#### 03 Save as PDF
plt.savefig("maps_KI_01_weekend_weekday_osm.pdf", bbox_inches = "tight")